...
public class FontAwesomeOptionsServlet extends AbstractOptionsProviderServlet {
    ...
    protected List<Option> getOptions(final ComponentServletRequest request) {
        ...
        return parseResourceForIconOptions(resource);
    }
    ...
    private Reader getReaderFromResource(Resource resource) {
        ...
        //TODO: Change these to constants. SURELY THEY'RE SOMEWHERE.
        Property dataProperty = node.getProperty("jcr:content/jcr:data");
        inputStreamReaderFromResource = new InputStreamReader(dataProperty.getBinary().getStream(), UTF_8)
