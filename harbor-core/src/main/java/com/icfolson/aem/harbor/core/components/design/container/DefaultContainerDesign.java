...
@Model(adaptables = Resource.class, adapters = ContainerDesign.class)
public class DefaultContainerDesign implements ContainerDesign {
    ...
    public boolean isUsesResponsiveGrid() {
        ...
        if (currentPage != null) {
            ...
            if (design != null) {
                return design.getStyle(resource).get(ContainerDesign.USES_RESPONSIVE_GRID, false);
            }
