...
@SlingServlet(resourceTypes = AllowedDynamicListItems.DATA_SOURCE_RESOURCE_TYPE)
public class AllowedDynamicListItemsDataSource  extends AbstractOptionsDataSourceServlet {
