package com.citytechinc.aem.harbor.core.services.clientlibs;
...
import com.citytechinc.aem.harbor.core.domain.brand.bootstrap.BootstrapBrand;
import com.citytechinc.aem.harbor.core.domain.brand.bootstrap.BootstrapBrands;
...
public class BootstrapVariableProvider implements VariableProvider {
	...
	public Map<String, String> getVariables(Resource root) {
		...
		if (templateResourceOptional.isPresent()) {
			...
			if (templateResourceComponentNode.get(Properties.CITYTECH_BRAND, String.class).isPresent()) {
