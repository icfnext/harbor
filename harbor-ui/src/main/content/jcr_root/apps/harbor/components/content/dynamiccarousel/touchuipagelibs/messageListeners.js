( function dynamicCarouselMessageListenerInitialization ( jQuery ) {
    ...
    jQuery( document ).ready ( function() {
        if ( typeof Granite !== 'undefined' && Granite.author && Granite.author.inner && Granite.author.inner.EditorFrame ) {
            ...
            Granite.author.inner.EditorFrame.subscribeRequestMessage( 'harbor-DynamicCarousel-nextSlide', function( r ) {
                console.log( r );
                jQuery( '.carousel[data-path="' + r.data.path + '"]' ).carousel( 'next' );
            } );

            Granite.author.inner.EditorFrame.subscribeRequestMessage( 'harbor-DynamicCarousel-previousSlide', function( r ) {
                console.log( r );
                jQuery( '.carousel[data-path="' + r.data.path + '"]' ).carousel( 'next' );
            } );
