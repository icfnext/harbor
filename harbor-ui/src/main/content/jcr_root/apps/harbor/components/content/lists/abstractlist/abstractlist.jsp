...
<%--
    ...
    but should be extended by extending the com.icfolson.aem.harbor.components.content.list.AbstractListComponent
    creating a concrete list implementation and indicating in said implementation that the resource super type of
    the component should be com.icfolson.aem.harbor.components.content.list.AbstractListComponent.RESOURCE_TYPE and
    that the component should be auto instantiated under the name 'listComponent' using the
    com.icfolson.cq.library.components.annotations.AutoInstantiate annotation.
--%>
