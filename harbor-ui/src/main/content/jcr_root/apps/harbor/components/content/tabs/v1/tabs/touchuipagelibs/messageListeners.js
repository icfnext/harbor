( function tabsMessageListenerInitialization ( jQuery ) {
    ...
    jQuery( document ).ready ( function() {
        if ( typeof Granite !== 'undefined' && Granite.author && Granite.author.inner && Granite.author.inner.EditorFrame ) {
            ...
            Granite.author.inner.EditorFrame.subscribeRequestMessage( 'harbor-Tabs-v1-nextTab', function( r ) {
            ...
            Granite.author.inner.EditorFrame.subscribeRequestMessage( 'harbor-Tabs-v1-previousTab', function( r ) {
