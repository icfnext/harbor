Harbor.Lists = function( ns, channel ) {
    ...
    var ListsEditor = function() {
        ...
        /**
         * Used to open a list item addition dialog.  Upon saving a POST will be sent to a new resource path
         * with the properties in the prescribed dialog.
         *
         * @param editable
         * @param dialogPath
         */
        this.addDynamicListItem = function( editable, dialogPath ) {
            ns.DialogFrame.openDialog( new AddItemDialog( editable, dialogPath ) );
        };
