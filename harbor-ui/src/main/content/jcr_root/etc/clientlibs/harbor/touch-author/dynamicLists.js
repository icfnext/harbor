Harbor.DynamicLists = function( ns, channel ) {

    var Dialog = function Dialog( dialogPath ) {
        this.dialogPath = dialogPath;
    };

    ns.util.inherits( Dialog, ns.edit.Dialog );
    ...
    Dialog.prototype.onSuccess = function ( currentDialog, currentFloatingDialog ) {
        var self = this;
        var properties = {};
        ...
        this.editable.refresh().done(function () {
