...
import com.citytechinc.cq.harbor.proper.core.content.page.navigation.impl.DefaultNavigablePage;
...
public class NavigablePages {
    ...
    public static NavigablePage forPageAndDepthAndChildPolicy(PageDecorator pageDecorator, Integer depth, Boolean respectHideInNav) {
        NavigationElementConfiguration navigationElementConfiguration = new NavigationElementConfiguration(respectHideInNav, depth);
        return new DefaultNavigablePage(pageDecorator, navigationElementConfiguration);
    }

    public static NavigablePage forPageAndDepthAndChildPolicyAndCurrentPage(PageDecorator pageDecorator, Integer depth, Boolean respectHideInNav, PageDecorator currentPage) {
        NavigationElementConfiguration navigationElementConfiguration = new NavigationElementConfiguration(respectHideInNav, depth, currentPage);
        return new DefaultNavigablePage(pageDecorator, navigationElementConfiguration);
    }
}
