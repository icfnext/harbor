...
@AutoInstantiate(instanceName = OldRSSFeed.RSS_FEED_NAME)
public class OldRSSFeed extends AbstractComponent {

    public static final String RSS_FEED_NAME = "rssFeed";

    public OldRSSFeed(ComponentRequest request) {
        super(request);
    }

    public OldRSSFeed(ComponentNode componentNode) {
        super(componentNode);
    }
