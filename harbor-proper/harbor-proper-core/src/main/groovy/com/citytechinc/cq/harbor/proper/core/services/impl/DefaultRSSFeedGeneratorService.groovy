package com.citytechinc.cq.harbor.proper.core.services.impl
...
import com.citytechinc.cq.harbor.proper.core.content.rss.impl.DefaultRSSFeedItem
...
public final class DefaultRSSFeedGeneratorService implements RSSFeedGeneratorService {
	...
	private RSSFeedItem getRSSFeedItemFromNode(Node node) {
		...
		return new DefaultRSSFeedItem(nodeTitle, nodeLink, nodePubDate, nodeDescription, HTML);
	}
